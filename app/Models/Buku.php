...
class Buku extends Model //nama class
{
    use HasFactory;
    protected $table = 'buku';
    protected $primaryKey = 'id_buku'; //primary key nya dalah id_buku (defaultnya id)
    public $timestamps = false;
    public $keyType = 'string'; //tipedata untuk primary key
    protected $fillable = [
        'id_buku',
        'id_kategori',
        'judul',
